...
const UpdateEmployee = () => {
  ...
  const [mobile, setMobile] = useState(singleEmployee?.mobile);
  const [employeeId, setEmployeeId] = useState(singleEmployee?.id);
  const [role, setRole] = useState(singleEmployee?.role);
  const [salary, setSalary] = useState(singleEmployee?.salary);
  const [address, setAddress] = useState(singleEmployee?.address);
